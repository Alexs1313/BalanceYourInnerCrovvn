...
const InnerCrovvnLoader = () => {
  const funnybirdsspinner = `
  <!DOCTYPE html>
    <html lang="en">
    <head>
      <meta charset="UTF-8" />
    ...
    >
      ...
      >
        <View style={styles.loadercnt}>
          <Image
            source={require('../../assets/images/crovvnlogo.png')}
            style={{ bottom: 50 }}
          />
        </View>
...
export default InnerCrovvnLoader;
