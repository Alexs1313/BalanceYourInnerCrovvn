export const innerCrovvnMoods = [
  {
    crovvntitle: 'Tense',
    crovvnimage: require('../../assets/images/crovvnmood1.png'),
    crovvndescr:
      'You feel the weight of the day. Take a breath — it’s okay to slow down.',
    id: '1',
    crovvnrec:
      'Your body feels tight, your breath uneven. Let go of what you can’t control — start with your breath.',
    crovvnsuggest: [
      {
        id: 1,
...
You don’t need to hold it all — not now.`,
  ...
  {
    crovvntitle: 'Unfocused',
    crovvnimage: require('../../assets/images/crovvnmood2.png'),
    crovvndescr:
      'Thoughts drift, attention fades. A minute of stillness will help you return.',
    id: '2',
    crovvnrec: `Your thoughts are scattered, your mind feels heavy. Anchor yourself in the present moment — one breath at a time.`,
    crovvnsuggest: [
      {
        id: 6,
...
Open your eyes with a quiet intention for today.`,
  ...
  {
    crovvntitle: 'Calm',
    crovvnimage: require('../../assets/images/crovvnmood3.png'),
    crovvndescr:
      'Your mind finds its rhythm again. Peace isn’t silence — it’s balance.',
    id: '3',
    crovvnrec:
      'You’ve found your rhythm — keep it steady. Breathe with awareness and stay gently connected to this calm.',
    crovvnsuggest: [
      {
        id: 5,
...
Let each breath smooth the edges of your thoughts.`,
  ...
  {
    crovvntitle: 'Energized',
    crovvnimage: require('../../assets/images/crovvnmood4.png'),
    crovvndescr:
      'You’re ready to move forward. Channel this spark with clarity and purpose.',
    id: '4',
    crovvnrec:
      'You’re awake and alive — direct your energy, don’t rush it. Turn movement into mindful focus.',
    crovvnsuggest: [
      {
        id: 2,
        crovvntitle: 'Morning Focus',
...
Let it energize you, not rush you.`,
  ...
  {
    crovvntitle: 'Grateful',
    crovvnimage: require('../../assets/images/crovvnmood5.png'),
    crovvndescr:
      'You feel light and centered. Every small moment today deserves',
    id: '5',
    crovvnrec:
      'Your heart feels open, your thoughts clear. Stay here a little longer — this is what balance feels like.',
    crovvnsuggest: [
      {
        id: 5,
        crovvntitle: 'Night Reset',
